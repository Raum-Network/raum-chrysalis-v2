...
app.get("/config", (_req: any, res: any) => {
  ...
  // Group protocols by destination chain key, splitting DeFi protocols from Circle services.
...
function chainKeyForGroup(group: string): string {
  // protocolGroupForChainKey maps chainKey->group; invert by scanning the chain config.
